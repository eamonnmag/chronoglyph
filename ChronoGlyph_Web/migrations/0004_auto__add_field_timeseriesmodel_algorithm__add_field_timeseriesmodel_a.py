...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeSeriesModel.algorithm'
        db.add_column(u'ChronoGlyph_Web_timeseriesmodel', 'algorithm',
                      self.gf('django.db.models.fields.CharField')(default='Maximal Repeats', max_length=256),
                      keep_default=False)

        # Adding field 'TimeSeriesModel.algorithm_parameter'
        db.add_column(u'ChronoGlyph_Web_timeseriesmodel', 'algorithm_parameter',
                      self.gf('django.db.models.fields.IntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeSeriesModel.algorithm'
        db.delete_column(u'ChronoGlyph_Web_timeseriesmodel', 'algorithm')

        # Deleting field 'TimeSeriesModel.algorithm_parameter'
        db.delete_column(u'ChronoGlyph_Web_timeseriesmodel', 'algorithm_parameter')
    ...
    models = {
        ...
        u'ChronoGlyph_Web.timeseriesmodel': {
            ...
            'algorithm': ('django.db.models.fields.CharField', [], {'default': "'Maximal Repeats'", 'max_length': '256'}),
            'algorithm_parameter': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
